<main>
    ...
    <form class="form container <?=$classname;?>" action="sign_up.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
        ...
        <div class="form__item <?=$classname;?>"> <!-- form__item--invalid -->
            ...
            <input id="email" type="text" name="signup[email]" placeholder="Введите e-mail" value="<?=$email;?>" required>
        ...
        <div class="form__item <?=$classname;?>">
            ...
            <input id="name" type="text" name="signup[username]" placeholder="Введите имя" value="<?=$username;?>" required>
        ...
        <div class="form__item <?=$classname;?>">
            ...
            <textarea id="message" name="signup[contacts]" placeholder="Напишите как с вами связаться" required><?=$contacts;?></textarea>
